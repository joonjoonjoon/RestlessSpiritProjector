...
namespace qtools.qhierarchy
{
    ...
    public class QHierarchy
    {
        ...
        public static Dictionary<Scene, QObjectList> objectListDictionary = new Dictionary<Scene, QObjectList>();
        ...
        public static void getGameObjectListRecursive(ref List<GameObject>result, GameObject gameObject, int maxDepth = int.MaxValue)
        {
        ...
        public static void setVisibility(QObjectList objectList, List<GameObject> gameObjects, bool targetVisibility, bool editMode)
        {            
        ...
        public static void setLock(QObjectList objectList, List<GameObject> gameObjects, bool targetLock)
        {
